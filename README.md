...
- 40 complete GraphQL query documents in [`graphql/`](graphql/)
- REST and configuration routes
- 51 convenience functions: 44 return pandas DataFrames; seven return a string, dictionary, or raw JSON
