...
- 37 complete GraphQL query documents in [`graphql/`](graphql/)
- REST and configuration routes
- 49 convenience functions: 42 return pandas DataFrames; seven return a string, dictionary, or raw JSON
